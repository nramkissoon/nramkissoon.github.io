...
Kleppmann partitions his book into 3 distinct parts which will serve as 
the structure for the rest of this overview and subsequent posts covering the latter 2 parts.
...
3. Maintainable - engineers can monitor and make changes without creating unecessary downtime
...
desicion-making process between the 2 models is maintainability. 
